$(document).ready(function () {
    ...
    function AppViewModel() {
        ...
        self.myAvatar = ko.observable("default.png");
        ...
        self.createRooms = function () {
            $('#ChrButton').attr("disabled", true);
            $('#ChrButton').removeClass("btn-success");
            $('#ChrButton').addClass("btn-warning");
            var name = $("#roomName").val();
            var Team1Id = $("#Team1").val();
            var Team2Id = $("#Team2").val();
            var RoomId = $("#RoomId").val();
            toastr.success("Your game room chats were automatically created! You will be redirected shortly");
            connection.invoke("CreateRooms", name, Team1Id, Team2Id, RoomId);
            setTimeout(() => window.location.href = "/Matches/ChatRoom", 1000);
